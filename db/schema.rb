...
ActiveRecord::Schema.define(version: 20190123080508) do
  ...
  create_table "spree_careers", force: :cascade do |t|
  ...
  create_table "spree_company_block_sections", force: :cascade do |t|
    t.bigint "company_block_id"
    t.integer "position"
    t.string "link"
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["company_block_id"], name: "index_spree_company_block_sections_on_company_block_id"
  end

  create_table "spree_company_blocks", force: :cascade do |t|
    t.boolean "is_active"
    t.string "main_statement"
    t.string "video_statement"
    t.string "video_cover_file_name"
    t.string "video_cover_content_type"
    t.integer "video_cover_file_size"
  ...
  create_table "spree_company_pages", force: :cascade do |t|
    t.integer "position"
    t.string "title"
    t.text "header"
    t.text "text"
  ...
  create_table "spree_contact_contents", force: :cascade do |t|
  ...
  create_table "spree_content_blocks", force: :cascade do |t|
    t.bigint "product_id"
  ...
  create_table "spree_downloads", force: :cascade do |t|
    t.string "name"
  ...
  create_table "spree_downloads_categories", force: :cascade do |t|
    t.integer "position"
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "spree_files", force: :cascade do |t|
    t.string "attachment_file_name"
    t.string "attachment_content_type"
    t.integer "attachment_file_size"
    t.datetime "attachment_updated_at"
  ...
  create_table "spree_footer_items", force: :cascade do |t|
    t.string "name"
    t.string "url"
    t.integer "position"
    t.datetime "created_at", null: false
  ...
  create_table "spree_hero_slides", force: :cascade do |t|
    t.string "title"
    t.string "link"
    t.integer "position"
    t.integer "title_vertical_align"
  ...
  create_table "spree_left_menu_items", force: :cascade do |t|
    t.bigint "store_id"
    t.integer "position"
    t.string "name"
    t.string "url"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["store_id"], name: "index_spree_left_menu_items_on_store_id"
  end

  create_table "spree_legal_pages", force: :cascade do |t|
    t.integer "position"
    t.string "title"
    t.string "slug"
    t.text "html"
  ...
  create_table "spree_news", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["category_id"], name: "index_spree_news_on_category_id"
    t.index ["sponsorship_id"], name: "index_spree_news_on_sponsorship_id"
  end

  create_table "spree_news_categories", force: :cascade do |t|
    t.integer "position"
    t.string "name"
    t.string "color"
    t.datetime "created_at", null: false
  ...
  create_table "spree_offline_stores", force: :cascade do |t|
    t.integer "position"
    t.string "name"
    t.string "pin_color"
    t.string "address"
  ...
  create_table "spree_online_stores", force: :cascade do |t|
    t.integer "position"
    t.string "name"
    t.string "url"
  ...
  create_table "spree_popular_searches", force: :cascade do |t|
    t.integer "position"
    t.string "text"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "spree_products", id: :serial, force: :cascade do |t|
    ...
    t.text "preview_features"
    t.boolean "hero_alignment_right", default: false, null: false
    t.string "hero_super_title"
    t.string "hero_title"
    ...
    t.string "hero_bg_image_file_name"
    t.string "hero_bg_image_content_type"
    t.integer "hero_bg_image_file_size"
    t.datetime "hero_bg_image_updated_at"
    t.string "hero_bg_color"
    t.string "video_file_name"
    t.string "video_content_type"
    t.integer "video_file_size"
    t.datetime "video_updated_at"
    ...
    t.string "model_year"
    t.text "disclaimer"
    t.boolean "hero_ui_white", default: true, null: false
    t.boolean "hero_ui_black"
    t.string "video_cover_file_name"
    t.string "video_cover_content_type"
    t.integer "video_cover_file_size"
    t.datetime "video_cover_updated_at"
    t.boolean "big_preview", default: false, null: false
    t.string "icon_white1_file_name"
    t.string "icon_white1_content_type"
    t.integer "icon_white1_file_size"
    t.datetime "icon_white1_updated_at"
    t.string "icon_dark1_file_name"
    t.string "icon_dark1_content_type"
    t.integer "icon_dark1_file_size"
    t.datetime "icon_dark1_updated_at"
    t.string "icon_white2_file_name"
    t.string "icon_white2_content_type"
    t.integer "icon_white2_file_size"
    t.datetime "icon_white2_updated_at"
    t.string "icon_dark2_file_name"
    t.string "icon_dark2_content_type"
    t.integer "icon_dark2_file_size"
    t.datetime "icon_dark2_updated_at"
    t.string "icon_white3_file_name"
    t.string "icon_white3_content_type"
    t.integer "icon_white3_file_size"
    t.datetime "icon_white3_updated_at"
    t.string "icon_dark3_file_name"
    t.string "icon_dark3_content_type"
    t.integer "icon_dark3_file_size"
    t.datetime "icon_dark3_updated_at"
    t.string "icon_white4_file_name"
    t.string "icon_white4_content_type"
    t.integer "icon_white4_file_size"
    t.datetime "icon_white4_updated_at"
    t.string "icon_dark4_file_name"
    t.string "icon_dark4_content_type"
    t.integer "icon_dark4_file_size"
    t.datetime "icon_dark4_updated_at"
    t.string "icon_white5_file_name"
    t.string "icon_white5_content_type"
    t.integer "icon_white5_file_size"
    t.datetime "icon_white5_updated_at"
    t.string "icon_dark5_file_name"
    t.string "icon_dark5_content_type"
    t.integer "icon_dark5_file_size"
    t.datetime "icon_dark5_updated_at"
    t.string "list_feature_left"
    t.string "list_feature_right"
  ...
  create_table "spree_property_value_icons", force: :cascade do |t|
    ...
    t.string "icon_dark_file_name"
    t.string "icon_dark_content_type"
    t.integer "icon_dark_file_size"
    t.datetime "icon_dark_updated_at"
    t.integer "position", default: 0
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["property_id"], name: "index_spree_property_value_icons_on_property_id"
  end
  ...
  create_table "spree_questions_categories", force: :cascade do |t|
    t.integer "position"
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "spree_right_menu_items", force: :cascade do |t|
    t.bigint "store_id"
    t.integer "position"
    t.string "name"
    t.string "url"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["store_id"], name: "index_spree_right_menu_items_on_store_id"
  end
  ...
  create_table "spree_sponsorships", force: :cascade do |t|
    t.integer "position"
    t.string "name"
    t.string "preview_image_file_name"
    t.string "preview_image_content_type"
  ...
  create_table "spree_stores", id: :serial, force: :cascade do |t|
    ...
    t.string "vk_link"
    t.string "yt_link"
    t.string "downloads_blank_text"
    t.string "downloads_blank_icon_file_name"
    t.string "downloads_blank_icon_content_type"
    t.integer "downloads_blank_icon_file_size"
    t.datetime "downloads_blank_icon_updated_at"
    t.string "string_file_name"
    t.string "string_content_type"
    t.integer "string_file_size"
    t.datetime "string_updated_at"
  ...
  create_table "spree_taxons", id: :serial, force: :cascade do |t|
    ...
    t.integer "image_file_size"
    t.datetime "image_updated_at"
    t.boolean "ui_black", default: false, null: false
    t.string "support_icon_file_name"
    t.string "support_icon_content_type"
    t.integer "support_icon_file_size"
    t.datetime "support_icon_updated_at"
    t.integer "filter1_id"
    t.integer "filter2_id"
    t.integer "filter3_id"
    t.integer "filter4_id"
    t.string "favorites_title"
    t.string "left_banner_title"
    t.string "left_banner_link"
    ...
    t.string "right_banner_title"
    t.string "right_banner_link"
    ...
    t.boolean "hide_from_sitemap", default: false, null: false
  ...
  create_table "spree_taxons_left_menu_items", force: :cascade do |t|
    t.bigint "taxon_id"
    t.string "name"
    t.string "link"
    t.integer "position"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["taxon_id"], name: "index_spree_taxons_left_menu_items_on_taxon_id"
  end

  create_table "spree_taxons_right_menu_items", force: :cascade do |t|
    t.bigint "taxon_id"
    t.string "name"
    t.string "link"
    t.integer "position"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["taxon_id"], name: "index_spree_taxons_right_menu_items_on_taxon_id"
  end
