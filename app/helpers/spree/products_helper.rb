module Spree
  module ProductsHelper
    def product_url(product)
      ...
      taxon = product.taxons.find_by(taxonomy_id: categories_taxonomy)
    ...
    def image_grids
      [
        ...
        [['image-grid__item_large'], ['image-grid__item_large']],
        [['image-grid__item_large'], ['image-grid__item_large', 'image-grid__item_large']],
        [['image-grid__item_large'], ['image-grid__item_large', '', '']],
        [['image-grid__item_large', 'image-grid__item_large'], ['image-grid__item_large', '', '']],
        [['', '', 'image-grid__item_large'], ['image-grid__item_large', '', '']],
        [['', '', 'image-grid__item_large'], ['', '', '', '']],
