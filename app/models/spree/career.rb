class Spree::Career < ApplicationRecord
  MAX_COUNT = 7
  ...
  has_attached_file :image,
                    ...
                    url: '/spree/careers/:id/images/:style/:basename.:extension',
                    path: ':rails_root/public/spree/careers/:id/images/:style/:basename.:extension',
  ...
  has_attached_file :video,
                    ...
                    url: '/spree/careers/:id/videos/:style/:basename.:extension',
                    path: ':rails_root/public/spree/careers/:id/videos/:style/:basename.:extension',
                    # default_style: :normal,
